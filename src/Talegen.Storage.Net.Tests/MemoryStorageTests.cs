...
namespace Talegen.Storage.Net.Tests
{
    ...
    /// <summary>
    /// This class contains unit tests for exercising the memory storage service.
    /// </summary>
    /// <seealso cref="Talegen.Storage.Net.Tests.UnitTestBase" />
    [Collection("Memory Storage Tests")]
    public class MemoryStorageTests : StorageTestsBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageTestsBase" /> class.
        /// </summary>
        public MemoryStorageTests()
            : base(new MemoryStorageContext("/", true))
        {
        }
    }
}