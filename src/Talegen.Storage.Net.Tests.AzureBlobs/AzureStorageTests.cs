...
namespace Talegen.Storage.Net.Tests.AzureBlobs
{
    ...
    public class AzureStorageTests : StorageTestsBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureStorageTests" /> class.
        /// </summary>
        public AzureStorageTests()
            : base(new AzureBlobStorageService("UseDevelopmentStorage=true;", "devstoreaccount1", true))
        {
        }
