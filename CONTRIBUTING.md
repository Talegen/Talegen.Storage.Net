...
For this Project, we use [GitHub Issues](https://github.com/Talegen/Talegen.Storage.Net/issues) to track all tasks related to this project.
...
Once you get the project built, see if you can fix some [issues](https://github.com/Talegen/Talegen.Storage.Net/issues).
